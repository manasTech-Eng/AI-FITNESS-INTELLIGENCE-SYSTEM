...
```bash
git clone https://github.com/manasTech-Eng/AI-FITNESS-INTELLIGENCE-SYSTEM.git
cd AI-FITNESS-INTELLIGENCE-SYSTEM
```
...
[![GitHub](https://img.shields.io/badge/GitHub-manasTech--Eng-181717?style=flat-square&logo=github)](https://github.com/manasTech-Eng)
